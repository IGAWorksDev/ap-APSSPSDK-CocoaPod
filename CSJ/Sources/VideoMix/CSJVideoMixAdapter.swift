...
public final class CSJVideoMixAdapter: APSSPVideoMixAdAdapterProtocol {
    ...
    private var interstitialVideoAdapter: CSJInterstitialVideoAdapter?
    private var interstitialAdapter: CSJInterstitialAdapter?
    private var rewardVideoAdapter: CSJRewardVideoAdapter?
    ...
    public func connectVideoMixDelegate(delegate: APSSPVideoMixAdAdapterDelegate) {
        ...
        case .Interstitial:
            interstitialAdapter = CSJInterstitialAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:])
            interstitialAdapter?.connectDelegate(delegate: self)
        case .InterstitialVideo:
            interstitialVideoAdapter = CSJInterstitialVideoAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:])
            interstitialVideoAdapter?.connectDelegate(delegate: self)
        case .RewardVideo:
            rewardVideoAdapter = CSJRewardVideoAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:])
...
extension CSJVideoMixAdapter: APSSPInterstitialAdapterDelegate {
...
extension CSJVideoMixAdapter: APSSPInterstitialVideoAdapterDelegate {
...
extension CSJVideoMixAdapter: APSSPRewardVideoAdapterDelegate {
    ...
    public func rewardVideoCompleted() { videoMixDelegate?.videoMixAdCompleteTrackingEvent(adNetworkNo: APSSPMediationCompany.CSJ.rawValue, isCompleted: true, type: videoMixAdType) }
}
