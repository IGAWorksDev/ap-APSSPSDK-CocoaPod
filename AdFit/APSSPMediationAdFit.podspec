Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/IGAWorksDev/ap-APSSPSDK-CocoaPod.git", :tag => "APSSPMediationAdFit-#{s.version.to_s}" }

  s.vendored_frameworks = "AdFit/APSSPMediationAdFit.xcframework"
