Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/IGAWorksDev/ap-APSSPSDK-CocoaPod.git", :tag => "APSSPMediationNAM-#{s.version.to_s}" }

  s.vendored_frameworks = "NAM/APSSPMediationNAM.xcframework"
  ...
  s.dependency "NAMSDK", "~> 8.20"
  s.dependency "NAMSDK/MediationNDA", "~> 8.20"
end
