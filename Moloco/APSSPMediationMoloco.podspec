Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/IGAWorksDev/ap-APSSPSDK-CocoaPod.git", :tag => "APSSPMediationMoloco-#{s.version.to_s}" }

  s.vendored_frameworks = "Moloco/APSSPMediationMoloco.xcframework"
