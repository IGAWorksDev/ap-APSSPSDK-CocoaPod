//
//  FBAudienceNetworkVideoMixAdapter.swift
...
final public class FBAudienceNetworkVideoMixAdapter: APSSPVideoMixAdAdapterProtocol {
    ...
    private var interstitialAdapter: FBAudienceNetworkInterstitialAdapter?
    private var interstitialVideoAdapter: FBAudienceNetworkInterstitialVideoAdapter?
    private var rewardVideoAdapter: FBAudienceNetworkRewardVideoAdapter?
    ...
    public func connectVideoMixDelegate(delegate: APSSPVideoMixAdAdapterDelegate) {
        ...
        case .Interstitial:
            interstitialAdapter = FBAudienceNetworkInterstitialAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:]); interstitialAdapter?.connectDelegate(delegate: self)
        case .InterstitialVideo:
            interstitialVideoAdapter = FBAudienceNetworkInterstitialVideoAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:]); interstitialVideoAdapter?.connectDelegate(delegate: self)
        case .RewardVideo:
            rewardVideoAdapter = FBAudienceNetworkRewardVideoAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:]); rewardVideoAdapter?.connectDelegate(delegate: self)
        @unknown default:
            break
        }
    }
...
extension FBAudienceNetworkVideoMixAdapter: APSSPInterstitialAdapterDelegate {
...
extension FBAudienceNetworkVideoMixAdapter: APSSPInterstitialVideoAdapterDelegate {
...
extension FBAudienceNetworkVideoMixAdapter: APSSPRewardVideoAdapterDelegate {
    ...
    public func rewardVideoCompleted() { videoMixDelegate?.videoMixAdCompleteTrackingEvent(adNetworkNo: APSSPMediationCompany.Facebook_Audience_Network.rawValue, isCompleted: true, type: videoMixAdType) }
}
